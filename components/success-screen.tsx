...
export default function SuccessScreen({ data, onStartNew }: SuccessScreenProps) {
  ...
  const handleDownloadSummary = () => {
    ...
    const summaryText = `
CLAIMADJUDICATE.AI - ADJUDICATION SUMMARY
================================
...
================================
This is an automated summary generated by ClaimAdjudicate.ai.
For any queries, contact claims@claimadjudicate.ai
    `.trim()
    ...
    link.href = url
    link.download = `ClaimAdjudicate_Summary_${patient.policyId}.txt`
